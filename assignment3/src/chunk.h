 ...
 * Returns the previous free chunk in the free chunk list.
 ...
 * Sets prev free chunk of Chunk_T c to prev * */
void 
chunk_set_prev_free_chunk(Chunk_T c, Chunk_T prev);

/* chunk_get_next_adjacent:
 * Returns the next adj chunk to to c.
 * If NULL, returns c as the last chunk in memory space. */
Chunk_T
